...
function updateLayoutView() {
    $.ajax({
        ...
        success: async function (response) {
            ...
            $.ajax({
                url: "https://localhost:7114/api/Chat/GetChatsBySenderOrReceiver",
                method: "GET",
                contentType: "application/json",
                data: {
                    id: currentUser.id
...
function updateChats() {
    $.ajax({
        url: "https://localhost:7114/Account/GetAllUsers",
        method: "GET",
        data: {
            key: "",
        },
...
function updateSpecialChat(senderId) {
    $.ajax({
        url: "https://localhost:7114/Account/GetUserById",
        method: "GET",
        contentType: "application/json",
        data: {
            id: senderId,
...
function setMessagesReaden(senderId) {
    $.ajax({
        ...
        success: function (response) {
            const currentUser = response.user;
            $.ajax({
                url: "https://localhost:7114/api/Message/SetMessagesReaden",
                method: "GET",
                contentType: "application/json",
                data: {
...
function updateMessages(receiverId) {
    $.ajax({
        ...
        success: function (response) {
            const currentUser = response.user;
            $.ajax({
                url: "https://localhost:7114/api/Chat/GetChatMessages",
                contentType: "application/json",
                method: "GET",
                data: {
...
function deleteChat() {
    $.ajax({
        url: "https://localhost:7114/Account/GetUserByUsername",
        contentType: "application/json",
        method: "GET",
        data: {
        ...
        success: function (response) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        url: "https://localhost:7114/api/Chat/ClearChatMessages",
                        contentType: "application/json",
                        method: "GET",
                        data: {
                            user1Id: senderId,
...
function deleteNotificationsOfCurrentUser() {
    $.ajax({
        ...
        success: function (response) {
            const currentUser = response.user;
            $.ajax({
                url: "https://localhost:7114/api/Notification/RemoveAllNotificationsOfUser",
                method: "GET",
                contentType: "application/json",
                success: function () {
...
function deleteNotification(notificationId) {
    $.ajax({
        url: "https://localhost:7114/api/Notification/RemoveNotification",
        method: "GET",
        contentType: "application/json",
        data: {
        ...
        success: function (response) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    const senderId = response.user.id;
                    $.ajax({
                        url: "https://localhost:7114/api/Chat/GetChatBySenderReceiverId",
                        contentType: "application/json",
                        method: "GET",
                        data: {
                            user1Id: senderId,
                        ...
                        success: function (response) {
                            ...
                            $.ajax({
                                url: "https://localhost:7114/api/Message/AddMessage",
                                contentType: "application/json",
                                method: "GET",
                                data: {
                                    chatId: chat.id,
...
function sendNotification(senderId,receiverId,notificationText) {
    $.ajax({
        url: "https://localhost:7114/api/Notification/AddNotification",
        contentType: "application/json",
        method: "GET",
        data: {
            senderId: senderId,
